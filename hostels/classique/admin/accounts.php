...
<div class="row">
	<div class="col-lg-12 col-md-12">
		...
		<div style="padding:5px; margin:5px;">
			<input type="button" class="btn btn-primary" value="Add account type" data-toggle="modal" data-target="#type"/>
			<input type="button" class="btn btn-primary" value="Add account name" data-toggle="modal" data-target="#name"/>
...
<!--ACCOUNTS TABS-->
			<div id="accounts_tabs">
				<ul>
					<li><a href="#types">Account types</a></li>
					<li><a href="#names">Account names</a></li>
						...
						while($row=mysqli_fetch_array($rQu)){
							...
							echo"
								<tr>
									<th>$i</th>
									<th>$name</th>
									<th><input type='submit' value='Delete' class='btn btn-danger btn-sm acc_delete' id='$id'</th>
								</tr>
							"; 
						}
					?>
...
<!--ACCOUNTS TRANSACTIONS SECTION-->
			...
			<?php
				if(isset($_POST['transact'])){
					...
					$s = "INSERT INTO transactions (account_name,Description,amount,tra_date) values('$acc_name','$description',$amount,now())";
					$rS = mysqli_query($con, $s);
					if($rS){
