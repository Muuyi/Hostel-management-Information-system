...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12">
			...
			<form method="POST" action="admin.php?search.php" enctype="multipart/form-data"  >
				<input type="text" id="search" name="search" class="form-control" placeholder="Search by name, ID number, Institution" />
				<div id="results"></div>
			</form><br />
		...
		<table width="100%" class="cTable" border="1px solid #000000">
			...
			<?php
				$i=0;
				$get_client = "select * from clients WHERE status = 'Check out'";
			...
			<tr>
				...
				<td id="cCheck">
					<?php
						 if($status =='Check in'){
								echo "<button class='btn btn-primary check' name='check' id='$cId'>Check out</button>	";
							}else {
								echo "
									<button class='btn btn-danger check' name='uncheck' id='$cId'>Check in</button>";
								}
					?>
				</td>
