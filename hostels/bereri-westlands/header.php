...
<html>
	<head>
		<title>BERERI HOSTELS WESTLANDS</title>
		...
		<style>
			.navbar{background-color:#008000; font-family:arial; }
	...
	<body>
		<header class="row">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12" style="color:#008000; font-weight:bolder;">
						<span id="ber_logo">BERERI HOSTELS WESTLANDS</span><br />
						<span id="ber_ch"><i>Choice for men & women</i></span>
					</div>
				</div>
			</div>
			<nav class="navbar navbar-inverse navbar-static-top" role="navigation">
				<div class="container" style="width:100%;">
					<div class="navbar-header">
						<a href="bookroom.php" class="navbar-brand hidden-lg hidden-md hidden-sm" style="font-family:algerian; font-size:20px; font-weight:bolder; color:#D2691E;">Book room</a>
