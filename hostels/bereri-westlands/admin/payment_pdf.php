<?php	
	...
	class PDF extends FPDF{
		function Header(){
			...
			$this -> Cell(12);
			$this -> Cell(0,10,'MODERN CHRISTIAN LADIES HOSTEL PAYMENT LIST',0,1,"C");
	...
	$query = mysqli_query($con, "SELECT * FROM payment INNER JOIN clients ON payment.Client_IDNo=clients.Client_IDNo ORDER BY day DESC");
	$i = 0;
