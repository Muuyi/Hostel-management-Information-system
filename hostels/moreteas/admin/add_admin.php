...
?>
	...
	<?php
		if(isset($_POST['add_admin'])){
			...
			$add_admin = "INSERT INTO admins (admin_FName,admin_LName,admin_Email,admin_IDNo,admin_Username,admin_squestion,admin_sanswer,admin_pass,admin_pic) values ('$ad_fname','$ad_lname','$ad_email','$id','$ad_user','$squestion','$sanswer','$ad_pass','$ad_pic')";
