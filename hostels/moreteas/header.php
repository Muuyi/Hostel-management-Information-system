...
<html>
	<head>
		<title>Moreteas Executive Ladies Hostel</title>
		...
		<style>
			.navbar{background-color:#000000; font-family:arial; }
	...
	<body>
		<header class="row">
			<div class="row">
				<img src="images/logo.jpg" class="img-responsive" width="90%" style="padding-left:30px;" />
			</div>
