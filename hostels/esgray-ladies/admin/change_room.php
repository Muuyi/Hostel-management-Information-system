							...
							if($photo == ''){
								echo"
									<div style='border:2px dashed; padding:10px; text-align:center; ' id='image'>
										<div id='img'>Please upload an image</div>
										<center><input type='file' name='file' id='file' /></center>
									</div>
									<div id='snglResponse'></div>
								";
							}else{
								echo"
									<div style='border:2px dashed; padding:10px; text-align:center; ' id='image'>
										<div id='img'><img src='images/$photo' width='100%' class='img-thumbnail img-responsive'></div>
										<center><b>Change image</b><input type='file' name='file' id='file' /></center>
									</div>
									<div id='snglResponse'></div>
								";
							}
