...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12">
			...
			<form method="POST" action="admin.php?search.php" enctype="multipart/form-data"  >
				<input type="text" id="search" name="search" class="form-control" placeholder="Search by  ID number, names, room number or institution of learning" />
			</form><br />
			<form class="forms" action="" method="POST">
				<a href="checkedout_pdf.php" target="_blank"><button type="button" class="btn btn-primary" >Print page</button></a>
			</form> <br /><br /><br /><br />
<div id="results">
