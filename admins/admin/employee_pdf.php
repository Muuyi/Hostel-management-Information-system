<?php	
	...
	class PDF extends FPDF{
		function Header(){
			...
			$this -> Cell(12);
			$this -> Cell(0,10,'MODERN CHRISTIAN LADIES HOSTEL EMPLOYEES LIST',0,1,"C");
			...
			$this -> Cell(15,5,'Salary',1,0,'',true);
	...
	while($row = mysqli_fetch_array($query)){
		$i++;
		$pdf -> Cell(9,5,$i,1,0);
		$pdf -> Cell(40,5,$row['emp_fname'].' '.$row['emp_lname'],1,0);
		$pdf -> Cell(16,5,$row['emp_idno'],1,0);
		$pdf -> Cell(20,5,$row['emp_phone'],1,0);
		$pdf -> Cell(40,5,$row['emp_email'],1,0);
		$pdf -> Cell(15,5,$row['emp_salary'],1,0);
		$pdf -> Cell(40,5,$row['emp_date'],1,1);
	}
	$pdf -> Output();
