<?php	
	...
	class PDF extends FPDF{
		function Header(){
			...
			$this -> Cell(12);
			$this -> Cell(0,10,strtoupper($rw['host_name']).' CHEKED OUT CLIENTS LIST',0,1,"C");
	...
	$query = mysqli_query($con, "SELECT * FROM ((clients LEFT OUTER JOIN room_numbers ON clients.rm_id=room_numbers.rm_id) LEFT OUTER JOIN universities ON clients.uni_id=universities.uni_id) WHERE clients.host_id=".$_GET['hst']." AND status='out'");
