<?php	
	...
	class PDF extends FPDF{
		function Header(){
			...
			$this -> Cell(12);
			$this -> Cell(0,10,strtoupper($rw['host_name']),0,1,"C");
			$this -> Cell(0,10,'SUPPLIERS LIST',0,1,"C");
			...
			$this -> Cell(35,5,'Product',1,1,'',true);
		}
		function Footer(){
			$this -> SetY(-15);
