...
<div class="row">
	<div class="col">
			<h1 style="text-align:center; color:#A52A2A; font-weight:bolder;">CLIENTS</h1>
				<a href="pdfs/checkedin_pdf.php?hst='<?php echo $_SESSION['hostel']?>'" target="_blank"><button type="button" class="btn btn-primary">Print client's details</button></a>
		...
		<div class="table-responsive">
			<table id="checkedin_clients_table" class="table table-bordered table-striped">
				<thead>
